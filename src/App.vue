      ...
      <div class="flex flex-col justify-center max-w-5xl w-2/3 m-auto">
        <div class="border-lightGray border-2 border-b-0 bg-white">
          ...
          >
            ...
            <Input class="mt-4 outline-none" @input="(v) => {
              this.tg = v
              checkBlock1()
          ...
          >
            ...
            <Slider class="mt-4" @input="(v) => {
              this.designPower = v
              checkBlock2()
            }" :min=0 :value="designPower" :max=100></Slider>
            <Input class="outline-none" @input="(v) => this.designComment = v" title="Ваш комментарий (По желанию)"></Input>
          </div>
          <div class="mt-2 pt-6 p-8 bg-white"
               :class="[
          ...
          >
            ...
            <Slider class="mt-4" @input="(v) => {
              ...
              checkBlock3()
            }" :min=0 :max=100 :value="animationsWill"></Slider>
            <Input class="outline-none" @input="(v) => this.animationsComment = v" title="Ваш комментарий (По желанию)"></Input>
          </div>
          <div class="mt-2 pt-6 p-8 bg-white"
               :class="[
          ...
          >
            <Input class="outline-none" @input="(v) => {
              this.routines = v
              checkBlock4()
            }" title="Как относитесь к рутинной работе?"></Input>
            <div class="text-pt16 mt-2 text-mainGray">
        ...
        <div class="bg-white">
          <button @click="sendForm" class="h-28 text-pt20 w-full font-extralight"
                ...
                // buttonState === 'filling' && 'shadow-leftMainGray',
                buttonState === 'correct' && 'shadow-mainGreenButton',
                // buttonState === 'error' && 'shadow-leftMainPink',
                ]"
          >
            Отправить
          </button>
